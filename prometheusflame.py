...
totem4 = transform.scale(image.load("firegame_images/totem4.png"), (60, 100))
totem5 = transform.scale(image.load("firegame_images/totem5.png"), (60, 100))
totem6 = transform.scale(image.load("firegame_images/totem6.png"), (60, 100))
totem7 = transform.scale(image.load("firegame_images/totem7.png"), (60, 100))
totem8 = transform.scale(image.load("firegame_images/totem8.png"), (60, 100))
totem9 = transform.scale(image.load("firegame_images/totem9.png"), (60, 100))
...
coin1 = transform.scale(image.load("firegame_images/coin1.png"), (24, 24))
coin2 = transform.scale(image.load("firegame_images/coin2.png"), (24, 24))
coin3 = transform.scale(image.load("firegame_images/coin3.png"), (24, 24))
coin4 = transform.scale(image.load("firegame_images/coin4.png"), (24, 24))
